...
ADVICE = {
    1: "Використовуй інерцію.",
    2: "Портали зберігають швидкість.",
    3: "Колір = напрям падіння.",
    4: "Змінюй гравітацію в польоті.",
    5: "JumpPad дає поштовх.",
    6: "Очі кубика підказують.",
    7: "Спробуй подвійний поворот.",
    8: "Тунелі пришвидшують.",
    9: "Стеж за кольором.",
    10: "Фініш світиться."
    }
advice_id = 1
